                ...
                if ($stmt->fetch()) {
                    if ($jogosultsag === "standard") {
                        if (password_verify($jelszo, $titkositottJelszo)) {
                            session_start();
                            $_SESSION['user_id'] = $id;
                            header("Location:http://127.0.0.1/FitneszFoglalasiRendszer/core/controller/ViewControllerFelhasznalo.php?actionFelhasznalo=fooldalFelhasznalo");
                            exit();
                        } else {
                    ...
                    while ($stmt->fetch()) {
                        ...
                        if ($jelszo === "Admin1234567") {
                            ...
                            if (password_verify($jelszo, $titkositottJelszo)) {
                                ...
                                header("Location: http://127.0.0.1/FitneszFoglalasiRendszer/core/controller/ViewControllerAdmin.php?actionAdmin=fooldalAdmin");
