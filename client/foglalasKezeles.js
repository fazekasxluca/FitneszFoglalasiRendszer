...
function AdatLekerdezesEsFrissites() {
    ...
    xhr.open("GET", "http://127.0.0.1/FitneszFoglalasiRendszer/index.php?oraMethod=getOsszesFoglalas", true);
...
function SzabadIdoPont() {
    ...
    fetch('http://127.0.0.1/FitneszFoglalasiRendszer/index.php?oraMethod=getSzabadIdoPont', {
        headers: {
...
function FoglalasMentes() {
    ...
    fetch('http://127.0.0.1/FitneszFoglalasiRendszer/index.php?oraMethod=SetFoglalas', {
        headers: {
            'Content-Type': 'application/json'
        },
        method: 'POST',
...
var fitneszOrak = []; 
 ...
 async function fetchFitneszOrak() {
    return fetch('http://127.0.0.1/FitneszFoglalasiRendszer/index.php?oraMethod=getOsszesFoglalas')
        .then(response => response.json())
        .then(data => {
            if (data.status === "success") {
...
async function FoglalasTorles() {
  await  fetchFitneszOrak(); 
    ...
    fetch('http://127.0.0.1/FitneszFoglalasiRendszer/index.php?oraMethod=delFoglalas', {
        headers: {
            'Content-Type': 'application/json'
        },
        method: 'DELETE',
