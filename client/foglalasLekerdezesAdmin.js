...
xhr.open("GET", "http://127.0.0.1/FitneszteremFoglalasiRendszer/index.php?foglalas=getFoglalas", true);
...
async function fetchFitneszOrak() {
    return fetch('http://127.0.0.1/FitneszteremFoglalasiRendszer/index.php?foglalas=getFoglalas')
...
async function KapacitasVisszaAllitas()
{
   ...
   if (adatok === null) {
    ...
    return;
     ...
     fetch('http://127.0.0.1/FitneszteremFoglalasiRendszer/index.php?foglalas=modKapacitas', {
        method: 'DELETE',
        headers: {
