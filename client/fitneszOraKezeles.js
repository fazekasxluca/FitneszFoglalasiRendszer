...
function fitneszOraHozzaAdas() {
    ...
    fetch('http://127.0.0.1/FitneszteremFoglalasiRendszer/index.php?method=setFitneszOra', {
        headers: {
...
function fitneszOraModositas() {
    ...
    fetch('http://127.0.0.1/FitneszteremFoglalasiRendszer/index.php?method=modFitneszOra', {
        headers: {
            'Content-Type': 'application/json'
        },
        method: 'PUT',
...
function fitneszOraTorles() {
    var data = getFormData();
    fetch('http://127.0.0.1/FitneszteremFoglalasiRendszer/index.php?method=delFitneszOra', {
        headers: {
            'Content-Type': 'application/json'
        },
        method: 'DELETE',
...
function AdatLekerdezesEsFrissites() {
    ...
    xhr.open('GET', 'http://127.0.0.1/FitneszteremFoglalasiRendszer/index.php?method=getFitneszOra', true);
