...
function UjAdminHozzadas() {
    ...
    fetch('http://127.0.0.1/FitneszteremFoglalasiRendszer/index.php?admin=setAdmin', {
        headers: {
...
function JelszoValtoztas() {
    ...
    fetch("http://127.0.0.1/FitneszteremFoglalasiRendszer/index.php?admin=modJelszo", {
        headers: {
            'Content-Type': 'application/json'
        },
        method: "PUT",
